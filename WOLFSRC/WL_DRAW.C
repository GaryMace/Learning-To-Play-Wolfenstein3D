...
#define DOORWALL	(PMSpriteStart-8) //Gary: Can add extra doors here
...
void HitHorizDoor (void)
{
	...
	// first pixel in this door
		...
		switch (doorobjlist[doornum].lock)	//Gary: more door types can be added in here
		{
		case dr_normal:
			doorpage = DOORWALL;
			break;
		...
		case dr_lock3:
		case dr_lock4:
			doorpage = DOORWALL+6;	//Gary: DOORWALL+<integer> matches the door-image file in the VSWAP file
			break;
		case dr_elevator:
			doorpage = DOORWALL+4;
			break;
